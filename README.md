...
dependencies {
    ...
    implementation("com.pexip.sdk:sdk-api-infinity:0.13.1")
    // A set of tools for interacting with an Infinity conference
    implementation("com.pexip.sdk:sdk-conference-infinity:0.13.1")
    // A set of tools for interacting with an Infinity registration
    implementation("com.pexip.sdk:sdk-registration-infinity:0.13.1")
