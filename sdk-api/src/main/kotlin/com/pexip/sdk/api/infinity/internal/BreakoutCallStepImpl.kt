...
internal class BreakoutCallStepImpl(
    override val participantStep: BreakoutParticipantStepImpl,
    override val callId: CallId,
) : InfinityService.CallStep,
    BreakoutParticipantStepImplScope by participantStep {
